...
public class RegisterActivity extends AppCompatActivity {
    ...
    private String emailPattern = "[a-zA-Z0-9._0]+@[a-z]+\\.+[a-z]+";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox.setText("");
        textView.setText(Html.fromHtml("I have read and agree to the " + "<a href ='https://www.blogger.com/u/1/blog/post/edit/preview/5093293064499667503/1006788425327784180'> Terms & Conditions</a>"));
    ...
    private boolean checkInputs(String email, String username, String password, Boolean tnc) {
        ...
        if (!email.matches(emailPattern)) {
            Toast.makeText(this, "Invalid email address, please enter a valid id and click on comfirm again", Toast.LENGTH_SHORT).show();
        }
